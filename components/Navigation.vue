  ...
  <div>
    <nav class="flex flex-col md:flex-row items-center justify-between px-4 md:px-10 py-2 bg-iridium">
      ...
      <div class="flex-grow flex items-center justify-center">
        <p class="animate_animated animate__bounceIn text-center md:text-left">
          {{ newroutename }} - Kryptos' Portfolio enjoy. {{ getTimezoneStatus() }}
        </p>
      </div>
      <img src="https://dcbadge.limes.pink/api/shield/820996713387917344?theme=gray&logoColor=presence"
    ...
    <div class="flex flex-col md:flex-row bg-baltic-sea">
      ...
      <router-link to="/" class="text-red-500 hover:bg-gray-800 animated-link" active-class="text-blue-500 font-bold"
       ...
       <router-link to="/introduction" class="text-red-500 hover:bg-gray-800 animated-link"
        active-class="text-blue-500 font-bold" exact>
        <div class="flex items-center">
          <img src="/icons/icon1.svg" alt="/icons/icon.png" class="w-5 h-auto mr-2" />
          <p>Introduction</p>
        </div>
      </router-link>
